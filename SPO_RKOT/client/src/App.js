...
function App() {
  ...
  const handleFile = async e => {
    ...
    for (let i = 0; i < lenOfFiles; i++) {
      ...
      if (!file.name.includes('.xlsx') || !file.name.includes('.xls')) return alert('Выбран не тот тип файлов')
  ...
  return (
    <div>
      ...
      <Table getDataList={getDataTables} openTable={open} show={openTable}
